...
def retrieve_config():
    try:
        with open('/home/enviropi/enviro-monitor/Config/config.json', 'r') as f:
...
def log_climate_and_gas(run_time, own_data, raw_red_rs, raw_oxi_rs, raw_nh3_rs, raw_temp, comp_temp, comp_hum,
    ...
    with open('/home/enviropi/enviro-monitor/envirolog', 'a') as f:
...
persistent_data_log = {}
try:
    with open('/home/enviropi/enviro-monitor/log-persistent', 'r') as f:
        ...
        while True:
            ...
            if time_since_short_update >= short_update_delay:
                ...
                if comms_failure == False:
                    with open('/home/enviropi/enviro-monitor/log', 'w') as f:
            ...
            if run_time > startup_stabilisation_time: # Wait until the gas sensors have stabilised before providing
                ...
                if time_since_long_update >= long_update_delay:
                    ...
                    with open('/home/enviropi/enviro-monitor/log-persistent', 'w') as f:
